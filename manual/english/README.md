...
source_url: https://github.com/manticoresoftware/manticoresearch/blob/master/manual/english/README.md
revision: 79de01fcd7ba55190ffc462f3783590cd1dd16a7
status: ready
---

# Documentação do Manticore Search
...
- [Installation](Installation/Installation.md)
  ...
  - [Compilando a partir do código-fonte](Installation/Compiling_from_sources.md)
  - [Manticore Buddy](Installation/Manticore_Buddy.md)
  - [Migração do Sphinx](Installation/Migration_from_Sphinx.md)
- [Guia de início rápido](Quick_start_guide.md)
- [Iniciando o servidor](Starting_the_server.md)
